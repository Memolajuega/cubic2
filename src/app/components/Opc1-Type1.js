export default function Opc1Type1({ respuesta, isClicked, setIsClicked, isCorrect, seleccionada, onClick }) {
  ...
  (En el return) <div className='sombritatype1' style={{ background: sombraBackground }}></div>*/
